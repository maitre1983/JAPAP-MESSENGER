"""
JAPAP Messenger — Shared Constants
===================================
Centralized lists used across auth.py, messaging.py, geo.py.
Avoids duplication and drift.
"""

# Supported translation target languages (3 Indian languages added in iter21)
SUPPORTED_LANGS = {
    'en', 'fr', 'pt', 'es', 'ar', 'sw', 'ln', 'yo',
    'hi',  # Hindi — most spoken in India (~600M speakers)
    'bn',  # Bengali — ~100M speakers in India + Bangladesh
    'ta',  # Tamil — ~80M speakers in South India + Sri Lanka
}
...
LANG_NAMES = {
    'en': 'English', 'fr': 'Français', 'pt': 'Português', 'es': 'Español',
    'ar': 'العربية', 'sw': 'Kiswahili', 'ln': 'Lingala', 'yo': 'Yoruba',
    'hi': 'हिन्दी', 'bn': 'বাংলা', 'ta': 'தமிழ்',
}

# Map country codes (ISO 3166-1 alpha-2) to preferred language code — used by geo-IP
# auto-detection. Falls back to 'en' for anything not listed.
COUNTRY_TO_LANG = {
    # French-speaking Africa
    'CM': 'fr', 'CD': 'fr', 'CG': 'fr', 'CI': 'fr', 'SN': 'fr', 'ML': 'fr',
    'BF': 'fr', 'TG': 'fr', 'BJ': 'fr', 'GA': 'fr', 'NE': 'fr', 'MG': 'fr',
    'TD': 'fr', 'GN': 'fr', 'RW': 'fr', 'BI': 'fr', 'DJ': 'fr', 'KM': 'fr',
    # Europe francophone
    'FR': 'fr', 'BE': 'fr', 'LU': 'fr', 'CH': 'fr', 'MC': 'fr',
    'CA': 'fr',  # Quebec defaults (could be 'en' too)
    # Portuguese
    ...
    'JO': 'ar', 'SY': 'ar', 'IQ': 'ar', 'YE': 'ar', 'LB': 'ar', 'PS': 'ar',
    'SD': 'ar', 'MR': 'ar', 'AE': 'ar', 'KW': 'ar', 'OM': 'ar', 'QA': 'ar',
    'BH': 'ar',
    # Swahili
    'TZ': 'sw', 'KE': 'sw', 'UG': 'sw',
    # Yoruba (mostly Nigeria)
    'NG': 'yo',
    # Indian languages
    'IN': 'hi', 'BD': 'bn', 'LK': 'ta',
}

# Country dial codes + names (ISO 3166-1 alpha-2) — 195 countries
# Flag emoji is derived client-side from the alpha-2 code (regional indicators).
COUNTRIES = [
